...
type Usecase interface {
	...
	CreateApplicationProfile(ctx context.Context, profile *entity.ApplicationProfile, graphData string) (*entity.ApplicationProfile, string, error)
	DeleteApplicationProfile(ctx context.Context, id uuid.UUID) error
	GetApplicationProfileByID(ctx context.Context, id uuid.UUID) (*entity.ApplicationProfile, string, error)
	GetApplicationProfileByVersion(ctx context.Context, applicationID uuid.UUID, version uint32) (*entity.ApplicationProfile, string, error)
	GetLatestApplicationProfile(ctx context.Context, applicationID uuid.UUID) (*entity.ApplicationProfile, string, error)
